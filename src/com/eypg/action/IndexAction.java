...
public class IndexAction extends ActionSupport {
	...
	public void getIndexPopProductList() {
		 ...
		 * 人气排行
		 */
		Pagination ComputerOfficePage = spellbuyrecordService.indexHotProductList(pageNo, 5);
	...
	public void getServerTime() {
		...
		// Struts2Utils.renderText((DateUtil.SDateTimeToDate(DateUtil.DateTimeToStr(new
	...
	public void getAllBuyCount() {
		...
		if (beginDateByAllCount == null) {
			// allBuyCount =
			// Long.parseLong(spellbuyrecordService.getAllByCount().toString());
			allBuyCount = 888l;
