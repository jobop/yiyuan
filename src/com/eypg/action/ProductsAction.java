...
public class ProductsAction extends ActionSupport {
	...
	public String index() throws ServletException, IOException {
		...
		// latestlotteryService.getLotteryDetail(Integer.parseInt(id)).get(0);
		// }
		...
		if (productInfo.getStatus() == 2) {
			...
			// "<script>window.location.href=\"/lotteryDetail/"+productInfo.getSpellbuyProductId()+".html\";</script>","encoding:UTF-8");
			return null;
	...
	public void isLottery() {
		...
		// spellbuyproduct = spellbuyproductService.findById(id);
		// endDate =
		// DateUtil.SDateTimeToDate(spellbuyproduct.getSpellbuyEndDate()).getTime();
		// nowDate = System.currentTimeMillis();
		// isLotteryJSON =
		// "{\"spStatus\":\""+spellbuyproduct.getSpStatus()+"\",\"date\":\""+((endDate-nowDate)/1000)+"\"}";
	...
	public static void main(String[] args) {
		// Long endDate =
		// DateUtil.SDateTimeToDate("2013-11-27 14:12:38").getTime();
		// Long nowDate = System.currentTimeMillis();
		// System.err.println((endDate-nowDate)/1000);
		// System.err.println(DateUtil.DateTimeToStr(DateUtil.subMinute(new
		// Date(), -3)));
