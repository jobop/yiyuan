...
public class PaymentForOnlineService {
	...
	private static String p1_MerId 			= ApplicationListenerImpl.sysConfigureJson.getYeepayPartner(); 			// 商家ID
	private static String queryRefundReqURL = "https://www.yeepay.com/app-merchant-proxy/command";	// 请求地址
	private static String keyValue 			= ApplicationListenerImpl.sysConfigureJson.getYeepayKey();				// 商家密钥
